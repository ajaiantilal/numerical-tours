...
export load_image, imageplot, rescale, clamP, snr, perform_wavelet_transf, plot_wavelet, compute_wavelet_filter, perform_wavortho_transf, plot_levelset, gaussian_blur, bilinear_interpolate, Grad, Div, perform_haar_transf, load_sound, perform_stft, plot_spectrogram, compute_max, perform_blurring, plot_vf, meshgrid, read_mesh, compute_boundary, plot_mesh, compute_normal, perform_linprog, plot_hufftree, perform_conjugate_gradient, perform_dijkstra_fm, cconvol, subsampling, upsampling, trim_dim, rand_discr, plot_multiclasses
